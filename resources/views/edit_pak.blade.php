                ...
                <div class="card-body">
                    ...
                    @php
                        $item_pj = \App\Pak::select('data_pengajuan.*')
                                ...
                                ->first();
                    @endphp
                    <form class="registrasi-form" method="POST" action="{{url('/update_pj/'.$item_pj->id)}}"  enctype="multipart/form-data">
                        @csrf
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="row">
                                                    <div class="col-md-12">
                                                           <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Nama" name="nama_pj" value="{{$pengaju->nama_pj}}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Masukan NIP" name="nip" value="{{$pengaju->nip}}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Masukan nomor seri karpeg" name="karpeg" value="{{$pengaju->karpeg}}">
                                                            <div class="kerpeg_error"></div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control" placeholder="Tempat Lahir" name="t_lahir" id="t_lahir" value="{{$pengaju->t_lahir}}">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <input type="text" class="form-control datepicker-autoclose" placeholder="Tanggal Lahir" name="tgl_lahir" id="tgl_lahir" value="{{Carbon\Carbon::createFromFormat('Y-m-d', $pengaju->tgl_lahir)->format('m/d/Y')}}">
                                            ...
                                            <div class="col-lg-6">
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <select class="form-control" name="pendidikan">
                                                                <option value="{{$pengaju->pendidikan}}" class="">{{$pengaju->pendidikan}}</option>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <label class="radio-inline mr-3">
                                                                <input type="radio" name="jk_pj" value="L" <?php echo ($pengaju->jk_pj == "L") ? "checked" : ""; ?>> Laki-laki</label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="jk_pj" value="P" <?php echo ($pengaju->jk_pj == "P") ? "checked" : ""; ?>> Perempuan</label>
                                                        </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <textarea class="form-control h-150" rows="5" id="comment" placeholder="Alamat" name="alamat_pj">{{$pengaju->alamat_pj}}</textarea>
                                ...
                                <div class="row align-items-center">
                                    <div class="col-lg-12">
                                        ...
                                        <select class="form-control pl_pangkat" name="pl_pangkat">
                                            <option value="{{$pengaju->pl_pangkat}}" class="">{{$pengaju->pl_pangkat}}</option>
                                        ...
                                        <select class="form-control pl_golongan" name="pl_golongan">
                                            <option value="{{$pengaju->pl_golongan}}" class="">{{$pengaju->pl_golongan}}</option>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control datepicker-autoclose" placeholder="TMT Pangkat" name="tmt_pangkat" id="tmt_pangkat" value="{{Carbon\Carbon::createFromFormat('Y-m-d', $pengaju->tmt_pangkat)->format('m/d/Y')}}">
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="form-group">
                                            <select class="form-control pilih_pangkat" name="pl_jabatan">
                                                <option value="{{$pengaju->pl_jabatan}}" class="">{{$pengaju->pl_jabatan}}</option>
                                        ...
                                        <div class="form-group">
                                            <select class="form-control pilih_pangkat" name="jj_jab" id="jj_jab">
                                                <option value="{{$pengaju->jj_jab}}" class="">{{$pengaju->jj_jab}}</option>
                                        ...
                                        <div class="form-group" id="jj_jab_ahli">
                                            <div class="ahli_lis" style="display:none">
                                                ...
                                                <select class="form-control" name="jj_jab_pr" id="jj_jab">
                                                    <option value="{{$pengaju->jj_jab_pr}}" class="">{{$pengaju->jj_jab_pr}}</option>
                                        ...
                                        <div class="form-group">
                                            <input type="text" class="form-control datepicker-autoclose" placeholder="TMT Jabatan" name="tmt_jabatan" id="tmt_jabatan" value="{{Carbon\Carbon::createFromFormat('Y-m-d', $pengaju->tmt_jabatan)->format('m/d/Y')}}">
                                    ...
                                    <div class="col-lg-12 mb-5">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    <label>Lama</label>
                                                    <input type="text" class="form-control" placeholder="Masa kerja golongan lama" name="ms_lama" value="{{$pengaju->ms_lama}}">
                                                    <div class="ms_lama_error"></div>
                                                </div>
                                                <div class="form-group">
                                                    <label>Baru</label>
                                                    <input type="text" class="form-control" placeholder="Masa kerja golongan baru" name="ms_baru" value="{{$pengaju->ms_baru}}">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Unit kerja" name="u_kerja" value="{{$pengaju->u_kerja}}">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-lg-3">
                                                        <input type="text" class="form-control datepicker-autoclose" placeholder="Tanggal Mulai" name="str_nilai" id="str_nilai" value="{{Carbon\Carbon::createFromFormat('Y-m-d', $pengaju->str_nilai)->format('m/d/Y')}}">
                                                    ...
                                                    <div class="col-lg-3">
                                                        <input type="text" class="form-control datepicker-autoclose" placeholder="Tanggal selesai" name="end_nilai" id="end_nilai" value="{{Carbon\Carbon::createFromFormat('Y-m-d', $pengaju->str_nilai)->format('m/d/Y')}}">
                                ...
                                <div class="col-lg-12">
                                    <div class="row">
                                        <div class="col-lg-12">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" placeholder="Tahun Penyusunan" name="thn_susun" value="{{$pengaju->thn_susun}}">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-3">
                                                <select class="form-control str_serah" name="str_serah">
                                                    <option value="{{$pengaju->str_serah}}" class="">{{$pengaju->str_serah}}</option>
                                            ...
                                            <div class="col-lg-3">
                                                <select class="form-control end_serah" name="end_serah">
                                                    <option value="{{$pengaju->end_serah}}" class="">{{$pengaju->end_serah}}</option>
                                                    <option value="Januari">Januari</option>
                                                    <option value="Februari">Februari</option>
                                                    <option value="Maret">Maret</option>
                                                    <option value="April">April</option>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="custom-file">
                                                    <input type="file" class="custom-file-input avatar-input" id="customFile" name="file_upl">
                                                    <label class="custom-file-label" for="customFile">{{$pengaju->file_upl}}</label>
                                                </div>
...
$(document).ready(function(){
    $(".registrasi-form").validate({
        ...
        messages: {
          ...
          kerpeg: "<span style='color: red;'>Nomor seri karpeg tidak boleh kosong</span>",
          alamat_pj: {
          ...
          thn_susun: "<span style='color: red;'>Masukan tahun penyusunan</span>",
