...
<body>
	<div class="header">
		<table style="width: 100%;" class="table-header">
			...
			<tr>
				<td style="padding-left: 50px; vertical-align: top;"><b>Kode: </b>guga</td>
			...
			<tr>
				...
				<td style="padding-left: 50px; padding-top: -5px;"><b>Posisi: </b>user</td>
			</tr>
			<tr>
				{{-- <td style="padding-left: 50px; padding-top: -5px;"><b>Nama: </b>{{ $users->name }}</td> --}}
				<td style="padding-left: 50px; padding-top: -5px;"><b>Nama: </b>Novri</td>
			</tr>
		</table>
	</div>
