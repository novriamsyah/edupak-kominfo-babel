...
<head>
    ...
    <title>E-dupak</title>
    <link rel="icon" href="{{asset('icons/dupak2.png')}}" type="image/png" sizes="16x16">
    ...
    <div id="main-wrapper">
        <div class="nav-header">
            <div class="brand-logo">
                <a href="{{ url('/dashboard') }}" style="pading: 10px;">
                    <b class="logo-abbr"><img src="{{ asset('icons/dupak3.png') }}" alt=""> </b>
                    <span class="logo-compact"><img src="{{ asset('icons/dupak1.png') }}" width="180" height="50" alt=""></span>
                    <span class="brand-title">
                        <img src="{{ asset('icons/dupak1.png') }}" width="180" height="50" alt="">
                    </span>
                </a>
            </div>
        </div>
                    ...
                    <ul class="clearfix">
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                <img src="{{ asset('pictures/default.png') }}" height="40" width="40" alt="">
                            </div>
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-th-large menu-icon"></i><span class="nav-text">Data saya</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="{{url('/kelola_pak')}}">Detail pengajuan saya</a></li>
                        </ul>
                    </li>
                    @endif
                    ...
                    <li class="mega-menu mega-menu-sm">
                        <a class="has-arrow" href="javascript:void()" aria-expanded="false">
                            <i class="fa fa-file-text menu-icon"></i><span class="nav-text">Unduh Data</span>
                        </a>
                        <ul aria-expanded="false">
                            <li><a href="3">Keterangan Perorangan</a></li>
                        </ul>
                    </li>
                    @endif --}}
                </ul>
